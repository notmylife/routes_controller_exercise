...
Response code of the request: Completed 200 OK in 140ms (Views: 89.9ms | ActiveRecord: 2.8ms)
...
It selects all the users in our database and paste them to the view.
